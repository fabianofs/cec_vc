<?php if(!class_exists('Rain\Tpl')){exit;}?>	<!-- Start Hero Slider -->
          ...
          <div class="tp-banner">
              <ul style="display:none;">
                  ...
                  <li data-transition="fade" data-slotamount="1" data-masterspeed="1000"  data-saveperformance="off"  data-title="Slide 1">
                      <!-- MAIN IMAGE -->
                      <img src="/res/site/images/slide.png"  alt="fullslide1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                      <!-- LAYERS -->
               ...
               data-endspeed="500" 
                          ...
                          style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">INTRODUCING 
                      </div>
               ...
               data-endspeed="500" 
                          ...
                          style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">NativeChurch - v1.5 
                      </div>
               ...
               data-endspeed="300" 
                  ...
                  <li data-transition="fade" data-slotamount="1" data-masterspeed="1000"  data-saveperformance="off"  data-title="Slide 2">
                      <!-- MAIN IMAGE -->
                      <img src="/res/site/images/slide2.jpg"  alt="fullslide1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                      <!-- LAYERS -->
      ...
      <div class="container">
        <div class="row"> 
          ...
          <div class="featured-blocks clearfix">
            <div class="col-md-4 col-sm-4 featured-block"> <a href="our-staff.html" class="img-thumbnail"> <img src="/res/site/images/staff.jpg" alt="staff"> <strong>Our Pastors</strong> <span class="more">read more</span> </a> </div>
            <div class="col-md-4 col-sm-4 featured-block"> <a href="about.html" class="img-thumbnail"> <img src="/res/site/images/newhere.jpg" alt="staff"> <strong>New Here</strong> <span class="more">read more</span> </a> </div>
            <div class="col-md-4 col-sm-4 featured-block"> <a href="sermons.html" class="img-thumbnail"> <img src="/res/site/images/sermons.jpg" alt="staff"> <strong>Sermons Archive</strong> <span class="more">read more</span> </a> </div>
          </div>
          <!-- End Featured Blocks --> 
        </div>
        <div class="row">
            ...
            <div class="listing post-listing">
              ...
              <section class="listing-cont">
                <ul>
                  <li class="item post">
                    <div class="row">
                      <div class="col-md-4"> <a href="#" class="media-box"> <img src="/res/site/images/blog-image3.jpg" alt="" class="img-thumbnail"> </a></div>
                      <div class="col-md-8">
                  ...
                  <li class="item post">
                    <div class="row">
                      <div class="col-md-4"> <a href="blog-post.html" class="media-box"> <img src="/res/site/images/blog-image2.jpg" alt="" class="img-thumbnail"> </a></div>
                      <div class="col-md-8">
                        <div class="post-title">
                          <h2><a href="blog-post.html">Voluptatum deleniti atque corrupti</a></h2>
                          <span class="meta-data"><i class="fa fa-calendar"></i> on 17th Dec, 2013</span></div>
  ...
  <div class="featured-gallery">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 col-sm-3 post format-image"> <a href="images/gallery-img1.jpg" class="media-box" data-rel="prettyPhoto[Gallery]"> <img src="/res/site/images/gallery-img1.jpg" alt=""> </a> </div>
        <div class="col-md-3 col-sm-3 post format-video"> <a href="http://youtu.be/NEFfnbQlGo8" class="media-box" data-rel="prettyPhoto[Gallery]"> <img src="/res/site/images/gallery-img2.jpg" alt=""> </a> </div>
        <div class="col-md-3 col-sm-3 post format-image"> <a href="images/gallery-img3.jpg" class="media-box" data-rel="prettyPhoto[Gallery]"> <img src="/res/site/images/gallery-img3.jpg" alt=""> </a> </div>
      </div>
    </div>
  </div>
